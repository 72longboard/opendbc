...
class CAR(Platforms):
  ...
  KIA_K5_HEV_2019 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia K5 Hybrid 2019", car_parts=CarParts.common([CarHarness.hyundai_h]))],
    KIA_K5_2019.specs,
    CarSpecs(mass=1595 *, wheelbase=2.8, steerRatio=13.27)
    HyundaiFlags.HYBRID,
  )
